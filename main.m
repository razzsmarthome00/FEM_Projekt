...
[qNewtonCu,~] = bound([1 2 3 4 5 6 14 18 20],e);
[qhCu, ~] = bound([17],e);
[q0Cu, ~] = bound([16 8],e);
[q0Ny,~] = bound([15 7],e);
...
Ep= [2 th];
Kmatrix = Kmatrix(Ex,Ey,Ep,Dny,Dcu,newedof,t,ndof,nelm);
...
af = solveq(Kmatrix,Hmatrix,bc);
ed = extract(newedof,af);

stress = stressFinder(Ex,Ey,Ep,Cny,Ccu,newedof,t,ndof,nelm,af);
